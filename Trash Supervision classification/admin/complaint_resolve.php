      ...
      <div class="content-wrapper">
        ...
        Complaint Resolved
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="complaint_resolve.php"> Complaint Resolved</a></li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				$atm=mysql_query("select * from complaint_register where status=1 order by cid DESC");
					...
					?>
                      ...
                      <tr>
						...
						<td><?php echo $row['cdate'];?></td>
							...
							<td  align="center"> <a class="btn btn-success" href="#">Complaint Resolved</a></td>

      ...
      <div class="content-wrapper">
       ...
       Public Complaint
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="complaint.php">Public Complaint</a></li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				$atm=mysql_query("select * from complaint_register order by cid DESC");
						...
						<?php
							 if($status==0)
							 {
								// $update=mysql_query("update trash set status=1 where trash_id='$trash_id");
								 ?>
								 <td  align="center" style="color:red"> <a class="btn btn-danger" href="send_alert.php?trash_id=<?php echo $trash_id; ?>&&type=c">Send Alert</a></td>
							<?php
							}
							else
							{
							?>
							<td  align="center"> <a class="btn btn-success" href="#">Complaint Sent</a></td>
							<?php
							}
							?>

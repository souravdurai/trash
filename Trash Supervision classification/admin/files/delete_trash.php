					...
					<div class="modal-body  gray-color">
					   <form name="editForm" id="edit-form" method="post" action="">
							...
							<div class="modal-footer mtop20">
								...
								<input type="button" name="s3" value="No" onclick="window.location.href='../trash.php'" class="btn btn-danger btn-add mtop10 mleft20 mright10 col-md-3"> 
							</div>
					   ...
					   if(isset($_POST['s1']))
								{
									...
									$delete=mysql_query("delete from trash where tid='$tid'");

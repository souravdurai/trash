      ...
      <div class="content-wrapper">
        ...
        Meter Tracking
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="meter_tracking.php">Meter Tracking</a></li>
          </ol>
        </section>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					?>
                      ...
                      <?php
							...
							?>
						<td><a href="meter.php?trash_level=<?php echo $trash_level; ?>&&trash_id=<?php echo $trash_id; ?>" class="btn btn-info">View Meter</a></td>
                      </tr>
                    <?php
					$i++;
						}

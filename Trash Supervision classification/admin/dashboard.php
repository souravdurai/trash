...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Trash Supervision | Dashboard</title>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"> Today Closing Amount </h4>
        </div>
		<?php
			$date=date('d-m-Y');
			$income=mysql_query("select * from payment where create_date='$date'");
			$income_count=mysql_num_rows($income);
			$income_amount=0;
			while($income_row=mysql_fetch_array($income))
			{
				$income_amount=$income_amount+$income_row['paid'];
			}
			echo $income_amount;

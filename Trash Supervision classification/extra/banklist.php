	...
	<header>
		...
		<nav>
			<ul id="menu">
				...
				<li><a href="bankreply.php"><span><span>Login</span></span></a></li>
...
<!-- content -->
	<div id="content">
		<div class="wrapper">
			...
			<div class="box pad_bot1 bot">
				...
				<form name="form1" method="post" action="#">
					<center><h2>ADD BANK DETAILS</h2>	</center>
					<table align="center" cellspacing="0" cellpadding="10">
						...
						<tr>
						<td> Branch Code</td>
					<td> <input type="text" name="bcode" required /></td>
						</tr>
		...
		$qry=mysql_query("insert into bank(bname,branch,bcode,ifsc,address,contact,uname)values('$bname','$branch','$bcode','$ifsc','$address','$contact','$uname')");
						  if($qry)
							{
